                        ...
                        <div class="card-body">
                            <div class="profile">
                                ...
                                <div class="profile-details">
                                    <h1>User's Name</h1>
                                    <p>Contact Information: user@email.com</p>
                                    <p>School/University: XYZ High School</p>
                                    <p>Grade Level: 12</p>
                                    <p>Major: Science</p>
                                    <p>About Me: I'm passionate about research and innovation. Let's collaborate!</p>
                                    <p>Activity Feed: Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
                                    <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw" style="margin-top: 2vh;">Edit Profile</button>
                                </div>
                            </div>
                        </div>
                     </div>
