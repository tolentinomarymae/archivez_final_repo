     ...
     <div
       ...
       <div class="flex flex-col overflow-y-auto md:flex-row">
         ...
         <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
           <div class="w-full">
             <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200">Login as Student</h1>
            ...
            <div class="form-group">
             ...
             <div class="signup-link">
               <p>Not a member yet? <router-link to="/studentsignup">Sign up</router-link></p>
             </div>
             <p class="mt-4">
